    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Chats_Detail_Activity.this, MainActivity.class);
                startActivity(intent);
            }
        });

        final ArrayList<Messeges> messegesModel = new ArrayList<>();

        final ChatAdapter chatAdapter = new ChatAdapter(messegesModel, this,receiveId);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot snapshot1 : snapshot.getChildren()){
                            Messeges model = snapshot1.getValue(Messeges.class);
                            model.setMessageId(snapshot1.getKey());

                            messegesModel.add(model);
                        }
